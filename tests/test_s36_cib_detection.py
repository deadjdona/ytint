...
import pytest
import pandas as pd
from pipeline.s36_cib_detection import detect_cib_rings, run_cib_detection
...
def test_run_cib_detection_execution(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("pipeline.s36_cib_detection.load_config", lambda: fake_config)
