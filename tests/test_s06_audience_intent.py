...
import pandas as pd
import tempfile
from pipeline.s06_audience_intent import classify_intent, run_audience_intent
...
def test_run_audience_intent_execution(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("pipeline.s06_audience_intent.load_config", lambda: fake_config)
